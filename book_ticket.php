...
<body>
            ...
            <div class="left-section">
                <div class="section">
                    ...
                    <div class="form-group">
                        ...
                        <span id="SoDienThoaiError" class="error-message" style="color:red; display:none;">Số điện thoại không hợp lệ!</span>
                    </div>
                    <div class="form-group">
            ...
            <div class="right-section">
                ...
                <div class="section">
                    ...
                    <form action="process_payment.php" method="POST" id="paymentForm" onsubmit="return validateForm()">
                        ...
                        <input type="hidden" name="SoDienThoai" id="SoDienThoaiInput">
                        <input type="hidden" name="DiaChi" id="DiaChiInput">
    ...
    <script>
        ...
        function validateForm() {
            ...
            const SoDienThoaiInput = document.getElementById('SoDienThoai').value;
            const DiaChiInput = document.getElementById('DiaChi').value;
            ...
            if (!phonePattern.test(SoDienThoaiInput)) {
                SoDienThoaiError.style.display = 'inline';  // Hiển thị thông báo lỗi
                isValid = false; // Đánh dấu là không hợp lệ
            } else {
                SoDienThoaiError.style.display = 'none';  // Ẩn thông báo lỗi nếu hợp lệ
            }
        ...
        document.addEventListener('DOMContentLoaded', function(){
            ...
            // Kiểm tra điều kiện validateForm trước khi submit
                if (!validateForm()) {
                    ...
                    document.getElementById('SoDienThoaiInput').value = document.getElementById('SoDienThoai').value;
                    document.getElementById('DiaChiInput').value = document.getElementById('DiaChi').value;
